# @agent-governance/governor

Framework-neutral governor: AsyncLocalStorage resource limits with sync/async limit tables.
...
```sh
npm install @agent-governance/governor
```
