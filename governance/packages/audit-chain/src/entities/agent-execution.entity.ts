...
import type { ReactStep } from './react-step.entity.js';
import { ToolCallRecord } from './tool-call-record.entity.js';
...
export class AgentExecution {
  ...
  // Relations
  @OneToMany('ReactStep', (step: ReactStep) => step.execution, { cascade: false })
  reactSteps?: ReactStep[];

  @OneToMany('ToolCallRecord', (tc: ToolCallRecord) => tc.execution, { cascade: false })
