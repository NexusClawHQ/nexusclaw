...
## Code contributions are temporarily gated

<!-- nexusclaw-contribution-mode: code-contributions-closed -->
...
maintainers cannot merge external code contributions. Opening a pull request,
adding a sign-off or using the Developer Certificate of Origin does not by
itself grant the relicensing rights required by this project policy.

Until the CLA is available, please use issues for non-security proposals and
follow [SECURITY.md](SECURITY.md) for vulnerabilities. A submitted pull request
will be closed without merging its commits. Maintainers must not copy,
translate, retype or clean-room-label copyrightable code or documentation from
an unlicensed pull request. Facts, bug descriptions and general ideas may be
